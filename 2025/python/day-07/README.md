...
With your analysis of the manifold complete, you begin fixing the teleporter. However, as you open the side of the teleporter to replace the broken manifold, you are surprised to discover that it isn't a classical tachyon manifold - _it's a quantum tachyon manifold._

With a quantum tachyon manifold, _only a single tachyon particle_ is sent through the manifold. A tachyon particle takes _both_ the left and right path of each splitter encountered.
